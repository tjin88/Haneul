...
from .views import AllNovelGetView, AllNovelSearchView, MangaCreateView, MangaUpdateView, MangaSearchView, login_view, register_view, UserProfileReadingListView, update_reading_list, delete_book_from_reading_list, update_to_max_chapter, LightNovelCreateView, LightNovelUpdateView, LightNovelSearchView
...
urlpatterns = [
    ...
    path('api/manga/search', MangaSearchView.as_view(), name='manga-search'),
